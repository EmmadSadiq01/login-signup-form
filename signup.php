...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $exist = false;
    $existsql = "SELECT * FROM `user_data` where `username` = '$user_name'";
    ...
    if($user_exist > 0){
        ...
        if (($password == $cpassword) || $exist=false) {
            ...
            $sql = "INSERT INTO `user_data` (`id`, `username`, `password`, `date`) VALUES (NULL, '$user_name', '$hash', current_timestamp())";
